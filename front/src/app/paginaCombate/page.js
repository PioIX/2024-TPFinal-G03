                                ...
                                <div className="fondoCombate">
                                    <div style={{ width: "100%", paddingLeft: "9%" }}>
                                        <div style={{ width: "70%" }}>
                                            ...
                                            {/*EL POKEMON DEL OTRO*/}
                                            <PokemonesCombate estado={pokemonPropio.status} tipo1={pokemonPropio.form.type1} tipo2={pokemonPropio.form.type2} nombrePokemon={pokemonPropio.apodo} vidaRestante={pokemonPropio.life} vidaPokemon={pokemonPropio.stats[0]} imagenPokemon={pokemonPropio.form.spriteBack}></PokemonesCombate>
                                        </div>
                                    </div>
                                    <div style={{ width: "80%" }}>
                                        <div style={{ width: "100%", paddingLeft: "30%", paddingTop: "10%" }}>
                                            {/*TU POKEMON*/}
                                            <PokemonesCombate estado={pokemonAjeno.status} tipo1={pokemonAjeno.form.type1} tipo2={pokemonAjeno.form.type2} nombrePokemon={pokemonAjeno.apodo} vidaRestante={pokemonAjeno.life} vidaPokemon={pokemonAjeno.stats[0]} imagenPokemon={pokemonAjeno.form.spriteFront}></PokemonesCombate>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div style={{ width: "100%", display: "inline-flex", backgroundColor: "gray" }}>
                                {pokemonPropio.isDefeated == true || pokemonAjeno.isDefeated == true
                                    ...
                                    : <>
                                            ...
                                            {datosLocales.turno == ""
                                                ? <>
                                                    <div style={{ width: "100%", display: "inline-flex", paddingTop: "3%", paddingBottom: "3%", paddingLeft: "3%", paddingRight: "3%" }}>
                                                        <Movimientos type={moves[pokemonPropio.moves[0]].type} funcion={seleccionarAtaquePropio} nombre={moves[pokemonPropio.moves[0]].name} valor={0} desabilitado={pokemonPropio.pps[0] == 0}></Movimientos>
                                                        <p style={{ width: "5%" }}></p>
                                                        <Movimientos type={moves[pokemonPropio.moves[1]].type} funcion={seleccionarAtaquePropio} nombre={moves[pokemonPropio.moves[1]].name} valor={1} desabilitado={pokemonPropio.pps[1] == 0}></Movimientos>
                                                    </div>
                                                    <div style={{ width: "100%", display: "inline-flex", paddingTop: "3%", paddingBottom: "3%", paddingLeft: "3%", paddingRight: "3%" }}>
                                                        <Movimientos type={moves[pokemonPropio.moves[2]].type} funcion={seleccionarAtaquePropio} nombre={moves[pokemonPropio.moves[2]].name} valor={2} desabilitado={pokemonPropio.pps[2] == 0}></Movimientos>
                                                        <p style={{ width: "5%" }}></p>
                                                        <Movimientos type={moves[pokemonPropio.moves[3]].type} funcion={seleccionarAtaquePropio} nombre={moves[pokemonPropio.moves[3]].name} valor={3} desabilitado={pokemonPropio.pps[3] == 0}></Movimientos>
                                                    </div>
                                                </>
                                                : <p>Esperando al otro jugador</p>
                                            }
                                        ...
                                        {datosLocales.turno == ""
                                            ? <div style={{width:"37%", display:"grid", paddingTop:"1%", paddingLeft:"5%"}}>
                                            <div style={{display:"grid"}}>
                                                <div style={{display:"inline-flex"}}>
                                                    {equipoPropio.map((pokemon, i) => {
                                                        if (i == 0 || i == 1) {
                                                            return (
                                                                <div key={i} style={{paddingLeft:"17%"}}>
