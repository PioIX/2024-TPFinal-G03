...
export let moves = [
    ...
    new Move("liquidation",85,100,16,"physical","water","lowDef",20), //FALTA HACER EL EFECTO
    ...
    new Move("brave-bird",120,100,24,"physical","flying","lowBothDef",100),//FALTA HACER EL EFECTO va a ser un a bocajarro de tipo volador
    new Move("hurricane",110,70,24,"special","flying","",0),//FALTA HACER EL EFECTO
    ...
    new Move("blizzard",110,70,24,"special","ice","freeze",10),//FALTA HACER EL EFECTO
    new Move("drill-run",80,100,24,"physical","ground","highCritical",100), 
    new Move("earth-power",90,100,24,"special","ground","lowSPD",10), 
    new Move("earthquake",100,100,24,"physical","ground","",0),//FALTA HACER EL EFECTO
    new Move("headlong-rush",120,100,24,"physical","ground","lowBothDef",100),//FALTA HACER EL EFECTO va a ser un a bocajarro de tipo volador
    new Move("thunder",110,70,24,"special","electric","paralisys",10),//FALTA HACER EL EFECTO
    ...
    new Move("supercell-slam",120,100,24,"physical","electric","lowBothDef",100),//FALTA HACER EL EFECTO va a ser un a bocajarro de tipo volador
    new Move("dragon-dance",0,100,32,"status","dragon","",""),
    new Move("outrage",120,100,24,"physical","dragon","lowBothDef",100),//FALTA HACER EL EFECTO va a ser un a bocajarro de tipo volador
    new Move("draco-meteor",130,90,8,"special","dragon","low2SPA",100), //FALTA HACER EL EFECTO
    ...
    new Move("close-combat",120,100,24,"physical","fighting","lowBothDef",100),//FALTA HACER EL EFECTO va a ser un a bocajarro de tipo volador
    new Move("focus-blast",120,70,24,"special","fighting","lowSPD",10),//FALTA HACER EL EFECTO
    new Move("superpower",120,100,24,"physical","fighting","lowDefAtk",100),//FALTA HACER EL EFECTO va a ser un a bocajarro de tipo volador
    new Move("sacred-sword",90,100,24,"physical","fighting","highCritical",100),//FALTA HACER EL EFECTO va a ser un a bocajarro de tipo volador
    ...
    new Move("psystrike",100,100,16,"special","psychic","",0),//FALTA HACER EL EFECTO
    new Move("psychic",90,100,24,"special","psychic","lowSPD",10),
    new Move("zen-headbutt",80,90,24,"physical","psychic", "flinch",10), //FALTA HACER EL EFECTO
    ...
    new Move("gunk-shot",120,80,8,"physical","poison", "poisoned",30), //FALTA HACER EL EFECTO
    new Move("sludge-wave",95,100,16,"special","poison", "poisoned",10), //FALTA HACER EL EFECTO
    new Move("sludge-bomb",90,100,16,"special","poison", "poisoned",30), //FALTA HACER EL EFECTO
    new Move("poison-jab",80,100,8,"physical","poison", "poisoned",30), //FALTA HACER EL EFECTO
    new Move("poltergeist",110,90,8,"physical","ghost", "",0), //FALTA HACER EL EFECTO
    ...
    new Move("sword-dance",0,100,32,"status","normal","",""),
    new Move("boomburst",140,100,8,"special","normal", "",0), //FALTA HACER EL EFECTO
    new Move("hyper-voice",90,100,8,"special","normal", "",0), //FALTA HACER EL EFECTO
    new Move("extreme-speed",70,100,8,"physical","normal","priority",100), 
    new Move("facade",70,100,8,"physical","normal","facade",100), 
    new Move("double-edge",120,100,24,"physical","normal","lowBothDef",100),//FALTA HACER EL EFECTO va a ser un a bocajarro de tipo volador
    new Move("dark pulse",80,100,8,"special","dark", "flinch",20), //FALTA HACER EL EFECTO
    new Move("knock-off",85,100,8,"physical","dark", "",0), //FALTA HACER EL EFECTO
    new Move("crunch",80,100,8,"physical","dark", "lowDef",20), //FALTA HACER EL EFECTO
    new Move("sucker-punch",70,100,8,"physical","dark", "suckerPriority",100), //FALTA HACER EL EFECTO
    new Move("night-slash",70,100,8,"physical","dark", "highCritical",100), //FALTA HACER EL EFECTO
]